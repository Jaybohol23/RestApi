...
try {
  ...
  for (const dir of getDirs) {
    ...
    for (j of fileName) {
      ...
      router.get(name, index);
      n++
      console.log('\x1b[38;5;220m[ LOADING ] \x1b[33m→\x1b[40m\x1b[1m\x1b[38;5;161m Successfully loaded ' + j);
    }
  }
  ...
  for (const dir of getDirsPost) {
    ...
    for (j of fileName) {
      ...
      router.post(name, index);
      n++
      console.log('\x1b[38;5;220m[ LOADING ] \x1b[33m→\x1b[38;5;197m Successfully loaded POST/' + j);
    }
  }
  console.log(`\x1b[38;5;220m[ LOADING ] \x1b[33m→\x1b[38;5;197m Successfully loaded ${n} API files`);
